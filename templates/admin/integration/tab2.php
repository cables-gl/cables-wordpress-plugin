                ...
                <div class="postbox">
                    <div class="inside">
                        <form method="POST" action="<?php echo $context['action_url']; ?>">
                            ...
                            <input name="mobile" id="mobile" type="checkbox"<?php if($context['styleConfig']->mobile): ?> checked="checked"<?php endif; ?>>
                            <label for="mobile"><?php echo i18n("page_style_block2_text"); ?></label><br/><br/>
